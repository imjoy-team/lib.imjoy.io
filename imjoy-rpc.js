          ...
          try {
            ...
            if (Array.isArray(code.requirements)) {
              for (var i = 0; i < code.requirements.length; i++) {
                ...
                } else if (code.requirements[i].toLowerCase().endsWith(".mjs") || code.requirements[i].startsWith("mjs:")) {
                  // import esmodule
                  if (code.requirements[i].startsWith("mjs:")) {
                    code.requirements[i] = code.requirements[i].slice(4);
                  }

                  await __webpack_require__("./src lazy recursive")(code.requirements[i]);
