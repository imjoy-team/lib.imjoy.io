...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.js */ "./src/hypha/utils.js");
...
class Timer {
  ...
  reset() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["assert"])(this._task, `Timer (${this._label}) is not started`);
    clearTimeout(this._task);
    this.start();
  }
...
class RPC extends _utils_js__WEBPACK_IMPORTED_MODULE_0__["MessageEmitter"] {
    ...
    if (this.manager_id) {
      ...
      try {
        ...
        if (this._connection_info.reconnection_token && this._connection.set_reconnection_token) {
          ...
          console.info(`Reconnection token obtained: ${this._connection_info.reconnection_token}, will be refreshed in ${reconnection_expires_in} seconds`);
  ...
  async get_remote_service(service_uri, timeout) {
    ...
    try {
      ...
      return await Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["waitFor"])(method(service_uri.split(":")[1]), timeout, "Timeout Error: Failed to get remote service: " + service_uri);
    } catch (e) {
...
/* harmony import */ var _rpc_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rpc.js */ "./src/hypha/rpc.js");
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.js */ "./src/hypha/utils.js");
...
class WebsocketRPCConnection {
  ...
  async open() {
    ...
    return await Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["waitFor"])(promise, this._timeout, "Timeout Error: Failed connect to the server " + server_url.split("?")[0]);
  }
...
async function connectToServer(config) {
  ...
  let connection = new WebsocketRPCConnection(server_url, clientId, config.workspace, config.token, config.method_timeout || 5);
